...
# Use a more descriptive header that includes the creation date for easier tracking
if not os.path.exists(mem_txt): open(mem_txt, 'w', encoding='utf-8').write(f'# [Global Memory - L2] (created {time.strftime("%Y-%m-%d")})\n')
